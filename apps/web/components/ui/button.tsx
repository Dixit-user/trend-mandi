  ...
  ({ className, variant = "primary", type = "button", ...props }, ref) => {
    return (
      <button
        ...
        type={type}
        className={cn(
          "focus-ring inline-flex min-h-10 items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-55",
          variants[variant],
          className
        )}
        {...props}
